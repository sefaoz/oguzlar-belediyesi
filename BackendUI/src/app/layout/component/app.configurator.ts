...
@Component({
    ...
    template: `
        <div class="flex flex-col gap-4">
            <!-- Renk seçimi kaldırıldı - Sabit olarak Blue ve Zinc kullanılıyor -->
            <div class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Tema Renkleri</span>
                <div class="text-sm text-muted-color">
                    <div class="flex items-center gap-2 mb-1">
                        <div class="w-4 h-4 rounded-full bg-blue-500"></div>
                        <span>Primary: Blue (Sabit)</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-4 h-4 rounded-full bg-zinc-500"></div>
                        <span>Surface: Zinc (Sabit)</span>
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-2">
